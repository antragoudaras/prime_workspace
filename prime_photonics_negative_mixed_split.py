...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_excel(f'./photonics_optimized_negative_results_mixed_80_split_correct_param_4/random_dataset_worst_80_train_split{batch_size}_size.xlsx')
    ...
    train_dataset.to_excel(f'./photonics_optimized_negative_results_mixed_80_split_correct_param_4/train_dataset_worst_80_train_split{batch_size}_size.xlsx')
    ...
    val_dataset.to_excel(f'./photonics_optimized_negative_results_mixed_80_split_correct_param_4/val_dataset_worst_80_train_split{batch_size}_size.xlsx')
...
train_eval_offline(
  ...
  eval_freq=250,
  add_summary=True,
  save_dir="./photonics_saved_weights_negative_mixed_split",
  loss_type='mse+rank',
  layers=(256, 256, 256),
