...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_csv('./results_dir_optimized_datasets/random_dataset_optimized_high_freq.csv')
    random_dataset.to_excel('./results_dir_optimized_datasets/random_dataset_optimized_high_freq.xlsx')
    ...
    train_dataset.to_csv('./results_dir_optimized_datasets/train_dataset_optimized_high_freq.csv')
    train_dataset.to_excel('./results_dir_optimized_datasets/train_dataset_optimized_high_freq.xlsx')
    ...
    val_dataset.to_csv('./results_dir_optimized_datasets/val_dataset_optimized_high_freq.csv')
    val_dataset.to_excel('./results_dir_optimized_datasets/val_dataset_optimized_high_freq.xlsx')
