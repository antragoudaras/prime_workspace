...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_csv(f'./results_dir_optimized_datasets/random_dataset_optimized_high_freq_{batch}_size.csv')
    random_dataset.to_excel(f'./results_dir_optimized_datasets/random_dataset_optimized_high_freq_{batch}_size.xlsx')
    ...
    train_dataset.to_csv(f'./results_dir_optimized_datasets/train_dataset_optimized_high_freq_{batch}_size.csv')
    train_dataset.to_excel(f'./results_dir_optimized_datasets/train_dataset_optimized_high_freq_{batch}_size.xlsx')
    ...
    val_dataset.to_csv(f'./results_dir_optimized_datasets/val_dataset_optimized_high_freq_{batch}_size.csv')
    val_dataset.to_excel(f'./results_dir_optimized_datasets/val_dataset_optimized_high_freq_{batch}_size.xlsx')
