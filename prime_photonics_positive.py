...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_excel(f'./photonics_optimized_positive_results_worst_80_split_correct_param_4/random_dataset_worst_80_train_split{batch_size}_size.xlsx')
    ...
    train_dataset.to_excel(f'./photonics_optimized_positive_results_worst_80_split_correct_param_4/train_dataset_worst_80_train_split{batch_size}_size.xlsx')
    ...
    val_dataset.to_excel(f'./photonics_optimized_positive_results_worst_80_split_correct_param_4/val_dataset_worst_80_train_split{batch_size}_size.xlsx')
