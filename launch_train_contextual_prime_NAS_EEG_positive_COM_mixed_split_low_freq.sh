...
SRC_DIR="$PROJECT_DIR"
JOB_RESULTS_DIR="$PROJECT_DIR"/contextual_EEG_low_freq_all_subjs_logs
OPTIMIZED_DATASET_DIR="$PROJECT_DIR"/contextual_all_subjs_EEG_low_freq_optimized_params_december
...
JOB_NAME=PRIME_contextual_all_subjs_EEG_low_freq_${TOTAL_STEPS}_grad_steps_${NUM_VOTES}_votes_${CQL_ALPHA}_cql_alpha_${INFEASIBLE_ALPHA}_infeasible_alpha
