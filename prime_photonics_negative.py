...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_excel(f'./photonics_optimized_negative_results_worst_80_split_corrected_signs/random_dataset_worst_80_train_split{batch_size}_size.xlsx')
    ...
    train_dataset.to_excel(f'./photonics_optimized_negative_results_worst_80_split_corrected_signs/train_dataset_worst_80_train_split{batch_size}_size.xlsx')
    ...
    val_dataset.to_excel(f'./photonics_optimized_negative_results_worst_80_split_corrected_signs/val_dataset_worst_80_train_split{batch_size}_size.xlsx')
...
train_eval_offline(
  ...
  eval_freq=250,
  add_summary=True,
  save_dir="./photonics_saved_weights_negative",
  loss_type='mse+rank',
  layers=(256, 256, 256),
