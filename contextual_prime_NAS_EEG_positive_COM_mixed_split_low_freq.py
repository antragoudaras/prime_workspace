...
def train_eval_offline(
  ...
  if skip_training:
    ...
    for step in range(train_steps):
      ...
      if step == 0:
        _ = model.measure_stats(batch, batch_type='valid')
        print("Load Weights from dir : contextual_low_freq_EEG_mixed_split_positive_COM_60001_steps_1_votes_0.1_cql_alpha_0.05_infeasible_alpha_512_batch_size", flush=True)
