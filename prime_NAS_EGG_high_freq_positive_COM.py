...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_csv(f'./results_dir_optimized_datasets/{save_dir}_random_dataset_optimized_high_freq_{batch_size}_size.csv')
    random_dataset.to_excel(f'./results_dir_optimized_datasets/{save_dir}_random_dataset_optimized_high_freq_{batch_size}_size.xlsx')
    ...
    train_dataset.to_csv(f'./results_dir_optimized_datasets/{save_dir}_train_dataset_optimized_high_freq_{batch_size}_size.csv')
    train_dataset.to_excel(f'./results_dir_optimized_datasets/{save_dir}_train_dataset_optimized_high_freq_{batch_size}_size.xlsx')
    ...
    val_dataset.to_csv(f'./results_dir_optimized_datasets/{save_dir}_val_dataset_optimized_high_freq_{batch_size}_size.csv')
    val_dataset.to_excel(f'./results_dir_optimized_datasets/{save_dir}_val_dataset_optimized_high_freq_{batch_size}_size.xlsx')
...
train_eval_offline(
  ...
  eval_freq=250,
  add_summary=True,
  save_dir='./tragos_discrete_high_freq_positive_COM',
  loss_type='mse+rank',
  layers=(256, 256, 256),
