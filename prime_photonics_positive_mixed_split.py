...
parser.add_argument("--train_steps", type=int, default=120000, help="A search state file to resume from")
...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_excel(f'./november_photonics_optimized_positive_results_mixed_80_split/random_dataset_{train_data}_steps{num_votes}_votes_{cql_alpha}_cql_alpha_{infeasible_alpha}_infeasible_alpha.xlsx')
    ...
    train_dataset.to_excel(f'./november_photonics_optimized_positive_results_mixed_80_split/train_dataset_{train_data}_steps{num_votes}_votes_{cql_alpha}_cql_alpha_{infeasible_alpha}_infeasible_alpha.xlsx')
    ...
    val_dataset.to_excel(f'./november_photonics_optimized_positive_results_mixed_80_split/val_dataset_{train_data}_steps{num_votes}_votes_{cql_alpha}_cql_alpha_{infeasible_alpha}_infeasible_alpha.xlsx')
