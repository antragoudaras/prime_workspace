...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_excel(f'./november_photonics_optimized_positive_results_mixed_80_split/random_set_{train_steps}_steps{num_votes}_votes_{cql_alpha}_cql_alpha_{infeasible_alpha}_infeasible_alpha.xlsx')
    ...
    train_dataset.to_excel(f'./november_photonics_optimized_positive_results_mixed_80_split/train_set_{train_steps}_steps{num_votes}_votes_{cql_alpha}_cql_alpha_{infeasible_alpha}_infeasible_alpha.xlsx')
    ...
    val_dataset.to_excel(f'./november_photonics_optimized_positive_results_mixed_80_split/val_set_{train_steps}_steps{num_votes}_votes_{cql_alpha}_cql_alpha_{infeasible_alpha}_infeasible_alpha.xlsx')
