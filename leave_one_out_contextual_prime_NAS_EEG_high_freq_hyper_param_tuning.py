...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    for idx in range(3):
      ...
      random_dataset.to_excel(os.path.join("contextual_leave_one_out_EEG_high_freq_optimized_params_december", "random_dataset_"+str(idx+1)+"_optimized_contextual_leave_one_out_high_freq_"+str(train_steps-1)+"_steps_"+str(args.cql_alpha)+"_alpha.xlsx"))
