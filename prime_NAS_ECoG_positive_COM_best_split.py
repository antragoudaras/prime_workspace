...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_csv(f'./ECoG_positive_COM_optimized_params/random_dataset_optimized_best_split.csv')
    random_dataset.to_excel(f'./ECoG_positive_COM_optimized_params/random_dataset_optimized_best_split.xlsx')
    ...
    train_dataset.to_csv(f'./ECoG_positive_COM_optimized_params/train_dataset_optimized_best_split.csv')
    train_dataset.to_excel(f'./ECoG_positive_COM_optimized_params/train_dataset_optimized_best_split.xlsx')
    ...
    val_dataset.to_csv(f'./ECoG_positive_COM_optimized_params/val_dataset_optimized_best_split.csv')
    val_dataset.to_excel(f'./ECoG_positive_COM_optimized_params/val_dataset_optimized_best_split.xlsx')
...
train_eval_offline(
  ...
  eval_freq=250,
  add_summary=True,
  save_dir='./ECoG_discrete_positive_COM_best_split',
  loss_type='mse+rank',
  layers=(256, 256, 256),
