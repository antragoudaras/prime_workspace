...
def train_eval_offline(
  ...
  if enable_discrete_optimizer:
    ...
    random_dataset.to_excel(f'./october_photonics_optimized_negative_results_best_80_split/random_dataset_{num_votes}_votes.xlsx')
    ...
    train_dataset.to_excel(f'./october_photonics_optimized_negative_results_best_80_split/train_dataset_{num_votes}_votes.xlsx')
    ...
    val_dataset.to_excel(f'./october_photonics_optimized_negative_results_best_80_split/val_dataset_{num_votes}_votes.xlsx')
...
train_eval_offline(
  ...
  eval_freq=500,
  add_summary=True,
  save_dir="negative_best_split_num_votes_one",
  loss_type='mse+rank',
  layers=(256, 256, 256),
